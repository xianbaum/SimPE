...
namespace pj
{
    class h3IDRHelp : IHelp
    {
        ...
        {
#if NET1
			string relativePathToHelp = "pj3IDRTool_NET1.plugin/pj3IDRTool_Help";
#else
            string relativePathToHelp = "pj3IDRTool.plugin/pj3IDRTool_Help";
#endif
			SimPe.RemoteControl.ShowHelp("file://" + SimPe.Helper.SimPePluginPath + "/" + relativePathToHelp + "/Contents.htm");
        }

        public override string ToString() { return L.Get("pj3IDRHelp"); }
