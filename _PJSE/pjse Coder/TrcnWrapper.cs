...
namespace SimPe.PackedFiles.Wrapper
{
    ...
    //,IPackedFileProperties		//This Interface can be used by thirdparties to retrive the FIleproperties, however you don't have to implement it!
    {
        ...
        {
            CleanUp();
            if (header[1] == 1) header[1] = 0x3f; // upgrades version 1 to 0x3F on saving
    ...
    public class TrcnItem : pjse.ExtendedWrapperItem<Trcn, TrcnItem>
	{
		...
		protected void Unserialize(System.IO.BinaryReader reader)
		{
            ...
            if (parent.Version == 1) // I doubt version 1 actually exists but this reads the unreadable type as version 1
            {
                ...
                while (bum != 0x64 && reader.BaseStream.Position < reader.BaseStream.Length) // 0x64 marks the end, may be problem if an unused att. has a value of 0x64
                {
                    bum = reader.ReadByte();
                }
                bum = reader.ReadByte();
