...
public class PinkyRenderer : ToolStripProfessionalRenderer
{
	private static Image menupattern;

	protected static Image MenuPattern => menupattern;

	protected PinkyColorTable Colors => ((ToolStripProfessionalRenderer)this).ColorTable as PinkyColorTable;
	...
	public PinkyRenderer()
		: base((ProfessionalColorTable)(object)PinkyColorTable.Global)
	{
