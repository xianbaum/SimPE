...
public class GlossyRenderer : AdvancedToolStripProfessionalRenderer
{
	...
	protected GlossyColorTable Colors => ((ToolStripProfessionalRenderer)this).ColorTable as GlossyColorTable;
	...
	public GlossyRenderer()
		: base((ProfessionalColorTable)(object)GlossyColorTable.Global)
	{
	...
	protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
	{
		...
		try
		{
			...
			val3.Positions = new float[4] { 0f, 0.495f, 0.505f, 1f };
