...
public class CoolblueRenderer : ToolStripProfessionalRenderer
{
	private static Image menupattern;

	protected static Image MenuPattern => menupattern;

	protected CoolblueColorTable Colors => ((ToolStripProfessionalRenderer)this).ColorTable as CoolblueColorTable;
	...
	public CoolblueRenderer()
		: base((ProfessionalColorTable)(object)CoolblueColorTable.Global)
	{
	...
	protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
	{
		...
		try
		{
			...
			val3.Positions = new float[4] { 0f, 0.495f, 0.555f, 1f };
