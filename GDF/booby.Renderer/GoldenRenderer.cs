...
public class GoldenRenderer : ToolStripProfessionalRenderer
{
	private static Image menupattern;

	protected static Image MenuPattern => menupattern;

	protected GoldenColorTable Colors => ((ToolStripProfessionalRenderer)this).ColorTable as GoldenColorTable;
	...
	public GoldenRenderer()
		: base((ProfessionalColorTable)(object)GoldenColorTable.Global)
	{
	...
	{
		if (((ToolStripItemRenderEventArgs)e).Item is ToolStripButton)
		{
			e.TextColor = Color.FromArgb(255, 255, 233);
		}
