...
public class GreenyRenderer : ToolStripProfessionalRenderer
{
	private static Image menupattern;

	protected static Image MenuPattern => menupattern;

	protected GreenyColorTable Colors => ((ToolStripProfessionalRenderer)this).ColorTable as GreenyColorTable;
	...
	public GreenyRenderer()
		: base((ProfessionalColorTable)(object)GreenyColorTable.Global)
	{
