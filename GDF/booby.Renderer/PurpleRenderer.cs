...
public class PurpleRenderer : ToolStripProfessionalRenderer
{
	...
	protected PurpleColorTable Colors => ((ToolStripProfessionalRenderer)this).ColorTable as PurpleColorTable;
	...
	public PurpleRenderer()
		: base((ProfessionalColorTable)(object)PurpleColorTable.Global)
	{
