...
public class PsychodelicRenderer : ToolStripProfessionalRenderer
{
	private static Image menupattern;

	protected static Image MenuPattern => menupattern;

	protected PsychodelicColorTable Colors => ((ToolStripProfessionalRenderer)this).ColorTable as PsychodelicColorTable;
	...
	public PsychodelicRenderer()
		: base((ProfessionalColorTable)(object)PsychodelicColorTable.Global)
	{
	...
	protected override void OnRenderToolStripBackground(ToolStripRenderEventArgs e)
	{
		...
		LinearGradientMode val = (LinearGradientMode)2;
		...
		try
		{
			...
			val3.Positions = new float[4] { 0f, 0.325f, 0.655f, 1f };
