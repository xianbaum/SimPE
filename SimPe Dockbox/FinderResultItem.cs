...
namespace SimPe.Plugin.Tool.Dockable
{
	...
	internal class ScenegraphResultItem : FinderResultItem
	{
        ...
        public ScenegraphResultItem(SimPe.Interfaces.Scenegraph.IScenegraphFileIndexItem fii) : base(SimPe.Localization.GetString("Unknown")) 
		{
            this.fii = fii;
            ...
            SimPe.Data.TypeAlias ta = Data.MetaData.FindTypeAlias(fii.FileDescriptor.Type);
            this.SubItems.Add(ta.Name);
        ...
        public ScenegraphResultItem(SimPe.Interfaces.Files.IPackageFile pkg, SimPe.Interfaces.Files.IPackedFileDescriptor pfd) : this(new FileIndexItem(pfd, pkg))
        {			
		}
