        ...
        public void RefreshDock(object sender, SimPe.Events.ResourceEventArgs es)
        {
            if (!es.Empty)
                if (es.HasFileDescriptor)
                {
                    ...
                    if (wrp != null)
                    {
                        rd.lbName.Visible = rd.lbDesc.Visible = rd.lbVersion.Visible = rd.lbAuthor.Visible = rd.lbFileName.Visible = rd.label5.Visible = rd.label2.Visible = rd.label1.Visible = rd.label3.Visible = rd.label14.Visible = true;
                        ...
                        rd.lbFileName.Text = wrp.WrapperFileName;
            ...
            rd.lbName.Text = rd.lbAuthor.Text = rd.lbFileName.Text = rd.lbVersion.Text = rd.lbDesc.Text = "";
            rd.lbName.Visible = rd.lbDesc.Visible = rd.lbVersion.Visible = rd.lbAuthor.Visible = rd.lbFileName.Visible = rd.label5.Visible = rd.label2.Visible = rd.label1.Visible = rd.label3.Visible = rd.label14.Visible = false;
            rd.pb.Image = null;
