...
namespace pjOBJDTool
{
    class hOBJDHelp : IHelp
    {
        ...
        {
#if NET1
			string relativePathToHelp = "pjOBJDTool_NET1.plugin/pjOBJDTool_Help";
#else
            string relativePathToHelp = "pjOBJDTool.plugin/pjOBJDTool_Help";
#endif
			SimPe.RemoteControl.ShowHelp("file://" + SimPe.Helper.SimPePluginPath + "/" + relativePathToHelp + "/Contents.htm");
        }

        public override string ToString() { return L.Get("pjOBJDHelp"); }
