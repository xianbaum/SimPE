...
namespace SimPe.Plugin
{
	...
	public class DownloadsToolFactory : SimPe.Interfaces.Plugin.AbstractWrapperFactory, SimPe.Interfaces.Plugin.IToolFactory, SimPe.Interfaces.Plugin.ISettingsFactory
	{
		...
		public DownloadsToolFactory() { SimPe.Packages.StreamFactory.CleanupTeleport(); }
		~DownloadsToolFactory() { SimPe.Packages.StreamFactory.CleanupTeleport(); }
		...
		public override SimPe.Interfaces.IWrapper[] KnownWrappers { get { IWrapper[] wrappers = { }; return wrappers; } }
		#endregion
