...
namespace SimPe.Plugin.Tool
{
	...
	public class Loads2cpTool : SimPe.Interfaces.IToolPlus	
	{
        ...
        public void Execute(object sender, ResourceEventArgs es)
        {
            ...
            ofd.Filter = SimPe.ExtensionProvider.BuildFilterString(new SimPe.ExtensionType[] { ExtensionType.Sim2PackCommunity, ExtensionType.Sim2Pack, ExtensionType.AllFiles });
		...
		public override string ToString() { return "Package Tool\\Open s2cp..."; }
		#endregion

		#region IToolExt Member
		public System.Windows.Forms.Shortcut Shortcut { get { return System.Windows.Forms.Shortcut.None; } }
		public System.Drawing.Image Icon { get { return SimPe.GetIcon.S2pcOpen; } }
