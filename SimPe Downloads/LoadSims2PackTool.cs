	...
	public class LoadSims2PackTool : SimPe.Interfaces.IToolPlus	
	{
        ...
        public void Execute(object sender, ResourceEventArgs es)
        {
            ...
            if (booby.PrettyGirls.IsTitsInstalled() || booby.PrettyGirls.IsAngelsInstalled())
                ofd.Filter = SimPe.ExtensionProvider.BuildFilterString(new SimPe.ExtensionType[] { ExtensionType.Sim2Pack, ExtensionType.Sim2PackCommunity, ExtensionType.AllFiles });
            else
            ...
            {
                SimPe.Packages.S2CPDescriptor[] ds = SimPe.Packages.Sims2CommunityPack.ShowOpenDialog(ofd.FileName, System.Windows.Forms.SelectionMode.One);
                if (ds != null)
		...
		public System.Drawing.Image Icon { get { return SimPe.GetIcon.S2packOpen; } }
