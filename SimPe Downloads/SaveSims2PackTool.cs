	...
	public class SaveSims2PackTool : SimPe.Interfaces.IToolPlus	
	{
        ...
        public void Execute(object sender, ResourceEventArgs es)
        {
            ...
            if (es.Loaded && es.LoadedPackage.FileName != "")
                SimPe.Packages.Sims2CommunityPack.ShowSaveDialog(new SimPe.Packages.GeneratableFile[] { es.LoadedPackage.Package }, false);
            else
                SimPe.Packages.Sims2CommunityPack.ShowSaveDialog(new SimPe.Packages.GeneratableFile[0], false);
        }
		public override string ToString() { return "Package Tool\\Create Sims2Pack..."; }
		#endregion

		#region IToolExt Member
		public System.Windows.Forms.Shortcut Shortcut { get { return System.Windows.Forms.Shortcut.None; } }
		public System.Drawing.Image Icon { get { return SimPe.GetIcon.S2pack; } }
