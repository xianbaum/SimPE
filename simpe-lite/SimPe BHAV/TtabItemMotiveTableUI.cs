...
namespace SimPe.PackedFiles.UserInterface
{
	...
	public class TtabItemMotiveTableUI : System.Windows.Forms.UserControl
	{
		...
		public TtabItemMotiveTableUI()
		{
			...
			lbMotive0.Tag  = (UInt16) 0; lbMotive1.Tag  = (UInt16) 1; lbMotive2.Tag  = (UInt16) 2; lbMotive3.Tag  = (UInt16) 3;
			lbMotive4.Tag  = (UInt16) 4; lbMotive5.Tag  = (UInt16) 5; lbMotive6.Tag  = (UInt16) 6; lbMotive7.Tag  = (UInt16) 7;
			lbMotive8.Tag  = (UInt16) 8; lbMotive9.Tag  = (UInt16) 9; lbMotive10.Tag = (UInt16)10; lbMotive11.Tag = (UInt16)11;
			lbMotive12.Tag = (UInt16)12; lbMotive13.Tag = (UInt16)13; lbMotive14.Tag = (UInt16)14; lbMotive15.Tag = (UInt16)15;
		}
		...
		public void SetData(TtabItem i)
		{
			...
			foreach (Control c in this.Controls)
				if (c.Name.StartsWith("lbMotive"))
				{
					Label lb = (Label)c;
					lb.Text = item.Opcodes.FindMotives((UInt16)lb.Tag);
					lb.Left = ttabMotiveGroupUI1.Left - lb.Width - 4;
				}

			foreach (Control c in this.Controls)
				if (c is TtabMotiveGroupUI)
				{
					TtabMotiveGroupUI mg = (TtabMotiveGroupUI)c;
					if (mg.MotiveGroup < item.nrGroups) mg.SetData(item);
					else mg.Visible = false;
				}
		}
		...
		private void InitializeComponent()
		{
			...
			this.Controls.Add(this.ttabMotiveGroupUI2);
			this.Controls.Add(this.ttabMotiveGroupUI3);
			this.Controls.Add(this.ttabMotiveGroupUI4);
			this.Controls.Add(this.ttabMotiveGroupUI5);
			this.Controls.Add(this.ttabMotiveGroupUI6);
			this.Controls.Add(this.ttabMotiveGroupUI7);
