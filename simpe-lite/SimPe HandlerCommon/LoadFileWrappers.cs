...
namespace SimPe
{
	...
	public class ToolMenuItem  : System.Windows.Forms.MenuItem
	{
		...
		System.EventHandler ChangeHandler 
		{
		...
		public static object[] LoadPlugins(string file, Type interfaceType, object[] args)
		{
			...
			foreach(Type t in mytypes)
			{
				...
				if (mit != null) 
				{
					...
					{
						Helper.ExceptionMessage("Unable to load "+t.Name+".", new Exception("Unable to load "+t.Name+" from '"+file+"'.", ex));
					}
				}
			}
