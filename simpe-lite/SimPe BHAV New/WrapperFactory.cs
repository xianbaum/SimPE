...
namespace SimPe.Plugin
{
	...
	/// </remarks>
	public class WrapperFactory2 : SimPe.Interfaces.Plugin.AbstractWrapperFactory
	{
		/// <summary>
		/// The Decoder registry Object you wanna use
		/// </summary>
		static DecoderRegistry dr = null;

		/// <summary>
		/// Return the active DecoderRegistry
		/// </summary>
		public static DecoderRegistry DecoderRegistry
		{
			get 
			{
				if (dr==null) dr = new DecoderRegistry();
				return dr;
			}
		}
		...
		public override SimPe.Interfaces.IWrapper[] KnownWrappers
		{
			get 
			{
				...
				{
					IWrapper[] wrappers = {
											  new Bhav2(LinkedProvider.OpcodeProvider)
										  };
					return wrappers;
				} 
				else 
