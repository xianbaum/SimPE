...
namespace System.Windows.Forms
{
    public partial class LabelledBoolsetControl : UserControl
    {
        ...
        public LabelledBoolsetControl()
        {
            ...
            {
                booby.ThemeManager.Global.AddControl(btnAll);
                booby.ThemeManager.Global.AddControl(btnNone);
                this.cklbBoolset.BackColor = booby.ThemeManager.Global.ThemeColorLight;
            }
        }
